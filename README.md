...
Back in the index.html file, add a link to the recipe page you just created. Example: Under the Odin Recipes heading, The text of the link should again be the recipe name.
